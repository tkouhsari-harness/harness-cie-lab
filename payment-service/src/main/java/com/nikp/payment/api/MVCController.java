...
public class MVCController {
  ...
  public String paymentSubmit(@ModelAttribute PaymentDto paymentDto,
    ...
    paymentRepository.save(new Payment(paymentDto.getUserId(), paymentDto.getAccountFrom(), paymentDto.getAccountTo(),
  ...
  public String paymentSubmitBank(@ModelAttribute PaymentDto paymentDto,
      @RequestParam(name = "number", required = false, defaultValue = "") String number,
      @RequestParam(name = "sename", required = false, defaultValue = "") String sename, Model model) {
